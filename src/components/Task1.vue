<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <v-container height="100vh" width="auto">
        ...
        >
            <template v-slot:top>
                <v-toolbar flat color="white">
                    <v-toolbar-title>Данные</v-toolbar-title>
                    <v-divider
                            class="mx-4"
                            inset
                            vertical
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        ...
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field type="number" v-model="editedItem.depth1"
                                                          label="Глубина 1"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field type="number" v-model="editedItem.depth2"
                                                          label="Глубина 2"></v-text-field>
                                        </v-col>
                                        <v-col cols="12" sm="6" md="4">
                                            <v-text-field type="number" v-model="editedItem.depth3"
                                                          label="Глубина 3"></v-text-field>
                                        </v-col>
                                    </v-row>
                                </v-container>
                            </v-card-text>
        ...
        <line-chart v-if="loaded" :label="resultName" :labels="postItem.humidity"
                    :data="postItem.strenght"></line-chart>
