<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
    <v-container height="100vh" width="auto">
        ...
        <p class="text-justify">Структурно-механические и реологические свойства формовочных масс можно характеризовать пластической прочностью структуры,
            представляющей собой предельное напряжение сдвига, которое может выдерживать формовочная масса при статическом нагружении.</p>
        <p class="text-justify">Пластичность глин и каолинов обуславливается способностью частичек при взаимодействий с водой образовывать гидратные оболочки (адсорбционный слой) с ориентацией молекул воды, что придает глине высокую вязкость.
            По мере удаления от поверхности твердой частицы молекулы воды теряют ориентацию, образуя за молекулярным (адсорбционным) слоем слой рыхло связанной, а затем и свободной воды, свойства которой неизменны.
            Количество воды необходимое для создания адсорбционного слоя с небольшим избытком свободной воды соответствует значению оптимальной влажности формовочной массы, которую определяют по предельному напряжению сдвига.
            Пластическую прочность (предельное напряжение сдвига) Pk рассчитывают по общей вертикальной нагрузке F на конус равной отношению суммарных усилий вдоль поверхности конуса к площади его боковой поверхности(S = πrl), погруженной в массу. </p>
        ...
        <p class="text-justify">где: Pk - предельное напряжение сдвига, Па;
            ...
            <br>Ka - константа конуса, зависящая только от угла при вершине(на данной странице используется константы конуса предложенные П.А.Ребиндером). </p>
...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            loaded: false,
            resultName: "График зависимости пластической прочности от влажности",
            label: "Пластическая прочность, Па",
            hAxisTitle: "Влажность, %",
            vAxisTitle:"Пластическая прочность, Па",
            depthNum: 3,
            postItem: {
                depth: [],
                humidity: [],
